...
<div class="col-sm-4">
  <img class="img-fluid pad" src="<?= base_url('ui-img/register.png') ?>" alt="registerLogo">
</div>
...
<div class="col-sm-8">
  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      <h5 class="card-title m-0">Lengkapi Profilmu!</h5>
    </div>
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-12">
          <button type="submit" class="btn btn-info btn-flat btn-block"><i class="fas fa-save"></i> Submit</a>
        </div>
      </div>
    </div>
  </div>
